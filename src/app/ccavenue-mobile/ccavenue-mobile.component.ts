...
export class CcavenueMobileComponent implements OnInit {
    ...
    constructor(private _route: ActivatedRoute, private _ccService: CCAvenueService, private _loader: LoaderService) { }
    ...
    onProceed() {
        ...
        console.log(data);
        this.loading = true;
        this._ccService.getEncryptedResponse(data).subscribe({
            next: (resp: any) => {
